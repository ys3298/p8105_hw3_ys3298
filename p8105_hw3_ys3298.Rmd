...
accel = select(sorted_accel, week, day_id, day, weekday_end, sum, everything())
table = select(sorted_accel, week, day_id, day, weekday_end, sum) 
knitr::kable(table)
...
#Are any trends apparent? NO
```

Comment: I rearrange the day_ id in oreder to put it into right order. This table in not clear to see the trend. From the plot, we can see in week1 and week2, the sum for each day increase from Monday to Sunday, however, in week3, week4 and week5, the trends are not so aparent.
