...
Comment: I rearrange the day_id in oreder to put it into right order. This table in not clear to see the trend. From the plot, we can see in week1 and week2, the sum for each day increase from Monday to Sunday, however, in week3, week4 and week5, the trends are not so aparent.
...
Comment: Based on this graph, we can see the activity is relatively low at the beginning of a day, and increase. The most active periods are around 12pm and 22pm. After 22pm, the value starts to decrease.
